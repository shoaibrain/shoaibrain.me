      ...
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex justify-center items-center w-96 md:w-1/2 text-center">
          <p className="text-xl leading-8 text-gray-700 text-left">
            Hi there! My name is <span className="font-bold">Shoaib Rain</span>. I&apos;m a software engineer, optimist, and sh*t poster on Twitter.
        ...
        <div className="container flex justify-center items-center w-96 md:w-1/2 text-center">
          <p className="text-xl leading-8 text-gray-700 text-left">
            Over past few years, I&apos;ve hold different roles & responsibilities; from building a feature-matrix documentation framework for
